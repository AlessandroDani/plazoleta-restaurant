...
public class OrderRestController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de eventos de trazabilidad del pedido", content = @Content(schema = @Schema(implementation = TraceabilityResponseDto.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Métricas de eficiencia de los pedidos por estado", content = @Content(schema = @Schema(implementation = OrderEfficiencyResponseDto.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ranking de empleados (email y número de pedidos finalizados)", content = @Content(schema = @Schema(implementation = EmployeePerformanceResponseDto.class))),
            @ApiResponse(responseCode = "403", description = "Usuario no autorizado (sólo propietarios)", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))),
